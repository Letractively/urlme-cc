namespace futonFinder.Data.Repository
{
    ...
    public class RepositoryBase
    {
        ...
        {
            string connectionString = "Data Source=sqlserver8.loosefoot.com;Initial Catalog=bakersdozen132;Persist Security Info=True;User ID=ihdavis2;Password=pchang"; // Core.Configuration.ConfigurationManager.Instance.ConnectionStrings["CrossBridge"].ConnectionString;
