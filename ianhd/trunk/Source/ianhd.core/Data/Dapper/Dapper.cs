...
Type type, IDataReader reader, int startBound = 0, int length = -1, bool returnNullIfFirstMissing = false
        ...
        public partial class GridReader : IDisposable
        {
            ...
            private IEnumerable<TReturn> MultiReadInternal<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(object func, string splitOn)
            {
                ...
                try
                {
                    foreach (var r in Dapper.MultiMapImpl<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(null, null, func, null, null, splitOn, null, null, reader, identity))
                    {
                        yield return r;
                    }
                }
    ...
    /// </summary>
    partial class DynamicParameters : Dapper.IDynamicParameters
    {
...
string name, object value = null, DbType? dbType = null, ParameterDirection? direction = null, int? size = null
        ...
        protected void AddParameters(IDbCommand command, Dapper.Identity identity)
        {
            if (templates != null)
            {
                foreach (var template in templates)
                {
                    ...
                    lock (paramReaderCache)
                    {
                        ...
                        {
                            appender = Dapper.CreateParamInfoGenerator(newIdent, true);
            ...
            foreach (var param in parameters.Values)
            {
                ...
                if (dbType == null && val != null) dbType = Dapper.LookupDbType(val.GetType(), name);
