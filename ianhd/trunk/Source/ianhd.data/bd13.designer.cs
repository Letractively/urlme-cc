...
namespace ianhd.data
{
    ...
    partial void InsertFeatureCategory(FeatureCategory instance);
    partial void UpdateFeatureCategory(FeatureCategory instance);
    partial void DeleteFeatureCategory(FeatureCategory instance);
    ...
    partial void InsertSiteFeature(SiteFeature instance);
    partial void UpdateSiteFeature(SiteFeature instance);
    partial void DeleteSiteFeature(SiteFeature instance);
    partial void InsertSiteFeatureCategory(SiteFeatureCategory instance);
    partial void UpdateSiteFeatureCategory(SiteFeatureCategory instance);
    partial void DeleteSiteFeatureCategory(SiteFeatureCategory instance);
    #endregion
		...
		public System.Data.Linq.Table<FeatureCategory> FeatureCategories
		{
			get
			{
				return this.GetTable<FeatureCategory>();
			}
		}
		...
		public System.Data.Linq.Table<SiteFeature> SiteFeatures
		{
			get
			{
				return this.GetTable<SiteFeature>();
			}
		}
		
		public System.Data.Linq.Table<SiteFeatureCategory> SiteFeatureCategories
		{
			get
			{
				return this.GetTable<SiteFeatureCategory>();
			}
		}
	}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="ihdavis2.FeatureCategory")]
	public partial class FeatureCategory : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private string _FeatureCategoryCd;
		...
		private EntitySet<SiteFeatureCategory> _SiteFeatureCategories;
		
    #region Extensibility Method Definitions
    partial void OnLoaded();
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnFeatureCategoryCdChanging(string value);
    partial void OnFeatureCategoryCdChanged();
    partial void OnTitleChanging(string value);
    partial void OnTitleChanged();
    partial void OnValueTypeChanging(string value);
    partial void OnValueTypeChanged();
    partial void OnMaxValueLengthChanging(int value);
    partial void OnMaxValueLengthChanged();
    partial void OnHintTextChanging(string value);
    partial void OnHintTextChanged();
    partial void OnCreateDateChanging(System.DateTime value);
    partial void OnCreateDateChanged();
    partial void OnModifyDateChanging(System.Nullable<System.DateTime> value);
    partial void OnModifyDateChanged();
		...
		{
			this._SiteFeatureCategories = new EntitySet<SiteFeatureCategory>(new Action<SiteFeatureCategory>(this.attach_SiteFeatureCategories), new Action<SiteFeatureCategory>(this.detach_SiteFeatureCategories));
			OnCreated();
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FeatureCategoryCd", DbType="NVarChar(10) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string FeatureCategoryCd
		{
			get
			{
				return this._FeatureCategoryCd;
			}
			set
			{
				if ((this._FeatureCategoryCd != value))
				{
					this.OnFeatureCategoryCdChanging(value);
					this.SendPropertyChanging();
					this._FeatureCategoryCd = value;
					this.SendPropertyChanged("FeatureCategoryCd");
					this.OnFeatureCategoryCdChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MaxValueLength", DbType="Int NOT NULL")]
		public int MaxValueLength
		{
			...
			set
			{
				if ((this._MaxValueLength != value))
				{
					this.OnMaxValueLengthChanging(value);
					this.SendPropertyChanging();
					this._MaxValueLength = value;
					this.SendPropertyChanged("MaxValueLength");
					this.OnMaxValueLengthChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_HintText", DbType="NVarChar(50)")]
		public string HintText
		{
			...
			set
			{
				if ((this._HintText != value))
				{
					this.OnHintTextChanging(value);
					this.SendPropertyChanging();
					this._HintText = value;
					this.SendPropertyChanged("HintText");
					this.OnHintTextChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FeatureCategory_SiteFeatureCategory", Storage="_SiteFeatureCategories", ThisKey="FeatureCategoryCd", OtherKey="FeatureCategoryCd")]
		public EntitySet<SiteFeatureCategory> SiteFeatureCategories
		{
			get
			{
				return this._SiteFeatureCategories;
			}
			set
			{
				this._SiteFeatureCategories.Assign(value);
			}
		}
		...
		private void attach_SiteFeatureCategories(SiteFeatureCategory entity)
		{
			this.SendPropertyChanging();
			entity.FeatureCategory = this;
		}
		
		private void detach_SiteFeatureCategories(SiteFeatureCategory entity)
		{
			this.SendPropertyChanging();
			entity.FeatureCategory = null;
		}
	}
    ...
    partial void OnModifyDateChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Site_SiteFeatureCategory", Storage="_SiteFeatureCategories", ThisKey="SiteCd", OtherKey="SiteCd")]
		public EntitySet<SiteFeatureCategory> SiteFeatureCategories
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="ihdavis2.SiteFeature")]
	public partial class SiteFeature : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private int _SiteFeatureId;
		
		private int _SiteFeatureCategoryId;
		...
		private EntityRef<SiteFeatureCategory> _SiteFeatureCategory;
		
    #region Extensibility Method Definitions
    partial void OnLoaded();
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnSiteFeatureIdChanging(int value);
    partial void OnSiteFeatureIdChanged();
    partial void OnSiteFeatureCategoryIdChanging(int value);
    partial void OnSiteFeatureCategoryIdChanged();
    partial void OnValueChanging(string value);
    partial void OnValueChanged();
    ...
    partial void OnModifyDateChanged();
		...
		public SiteFeature()
		{
			this._SiteFeatureCategory = default(EntityRef<SiteFeatureCategory>);
			OnCreated();
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SiteFeatureId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int SiteFeatureId
		{
			get
			{
				return this._SiteFeatureId;
			}
			set
			{
				if ((this._SiteFeatureId != value))
				{
					this.OnSiteFeatureIdChanging(value);
					this.SendPropertyChanging();
					this._SiteFeatureId = value;
					this.SendPropertyChanged("SiteFeatureId");
					this.OnSiteFeatureIdChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SiteFeatureCategoryId", DbType="Int NOT NULL")]
		public int SiteFeatureCategoryId
		{
			get
			{
				return this._SiteFeatureCategoryId;
			}
			set
			{
				if ((this._SiteFeatureCategoryId != value))
				{
					if (this._SiteFeatureCategory.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnSiteFeatureCategoryIdChanging(value);
					this.SendPropertyChanging();
					this._SiteFeatureCategoryId = value;
					this.SendPropertyChanged("SiteFeatureCategoryId");
					this.OnSiteFeatureCategoryIdChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SiteFeatureCategory_SiteFeature", Storage="_SiteFeatureCategory", ThisKey="SiteFeatureCategoryId", OtherKey="SiteFeatureCategoryId", IsForeignKey=true)]
		public SiteFeatureCategory SiteFeatureCategory
		{
			get
			{
				return this._SiteFeatureCategory.Entity;
			}
			set
			{
				SiteFeatureCategory previousValue = this._SiteFeatureCategory.Entity;
				if (((previousValue != value) 
							|| (this._SiteFeatureCategory.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._SiteFeatureCategory.Entity = null;
						previousValue.SiteFeatures.Remove(this);
					}
					this._SiteFeatureCategory.Entity = value;
					if ((value != null))
					{
						value.SiteFeatures.Add(this);
						this._SiteFeatureCategoryId = value.SiteFeatureCategoryId;
					}
					else
					{
						this._SiteFeatureCategoryId = default(int);
					}
					this.SendPropertyChanged("SiteFeatureCategory");
				}
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="ihdavis2.SiteFeatureCategory")]
	public partial class SiteFeatureCategory : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<SiteFeature> _SiteFeatures;
		
		private EntityRef<FeatureCategory> _FeatureCategory;
    ...
    partial void OnModifyDateChanged();
		...
		public SiteFeatureCategory()
		{
			this._SiteFeatures = new EntitySet<SiteFeature>(new Action<SiteFeature>(this.attach_SiteFeatures), new Action<SiteFeature>(this.detach_SiteFeatures));
			this._FeatureCategory = default(EntityRef<FeatureCategory>);
			this._Site = default(EntityRef<Site>);
			OnCreated();
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SiteFeatureCategoryId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int SiteFeatureCategoryId
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FeatureCategoryCd", DbType="NVarChar(10) NOT NULL", CanBeNull=false)]
		public string FeatureCategoryCd
		{
			get
			{
			...
			set
			{
				if ((this._FeatureCategoryCd != value))
				{
					if (this._FeatureCategory.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnFeatureCategoryCdChanging(value);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SiteFeatureCategory_SiteFeature", Storage="_SiteFeatures", ThisKey="SiteFeatureCategoryId", OtherKey="SiteFeatureCategoryId")]
		public EntitySet<SiteFeature> SiteFeatures
		{
			get
			{
			...
			set
			{
				this._SiteFeatures.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FeatureCategory_SiteFeatureCategory", Storage="_FeatureCategory", ThisKey="FeatureCategoryCd", OtherKey="FeatureCategoryCd", IsForeignKey=true)]
		public FeatureCategory FeatureCategory
		{
			get
			{
				return this._FeatureCategory.Entity;
			}
			set
			{
				FeatureCategory previousValue = this._FeatureCategory.Entity;
				if (((previousValue != value) 
							|| (this._FeatureCategory.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._FeatureCategory.Entity = null;
						previousValue.SiteFeatureCategories.Remove(this);
					}
					this._FeatureCategory.Entity = value;
					if ((value != null))
					{
						value.SiteFeatureCategories.Add(this);
						this._FeatureCategoryCd = value.FeatureCategoryCd;
					}
					else
					{
						this._FeatureCategoryCd = default(string);
					}
					this.SendPropertyChanged("FeatureCategory");
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Site_SiteFeatureCategory", Storage="_Site", ThisKey="SiteCd", OtherKey="SiteCd", IsForeignKey=true)]
		public Site Site
		{
			get
			{
		...
		private void attach_SiteFeatures(SiteFeature entity)
		{
			this.SendPropertyChanging();
			entity.SiteFeatureCategory = this;
		}
		
		private void detach_SiteFeatures(SiteFeature entity)
		{
			this.SendPropertyChanging();
			entity.SiteFeatureCategory = null;
		}
	}
}
