...
<head runat="server">
    ...
    <script src="<%=ResolveUrl("~/") %>Resource/javascript/jquery.tablesorter.js" type="text/javascript"></script>
    <script src="<%=ResolveUrl("~/") %>Resource/javascript/jquery.tablesorter.pager.js" type="text/javascript"></script>
</head>
<body>
        ...
        <asp:Repeater runat="server" ID="LinksRepeater">
            ...
            <ItemTemplate>
                    <tr id="DisplayLinkRow-<%# Eval("LinkID") %>" class="DisplayRow">
                        ...
                        <td style="width: 90px"><a href="#" onclick="EditRow(<%# Eval("LinkID") %>); return false;">Edit</a>&nbsp;|&nbsp;<a href="#" onclick="svc.DeleteLink(<%# Eval("LinkID") %>); return false;">Delete</a>&nbsp;<input class="RowCheckbox" type="checkbox" id="Checkbox-<%# Eval("LinkID") %>" name="Checkbox-<%# Eval("LinkID") %>" /></td>
                    </tr>
