...
namespace UrlMe.cc.Data
{
    ...
    partial void DeleteLink(Link instance);
		...
		public UrlMe_ccDataContext() : 
				base(global::UrlMe.cc.Data.Properties.Settings.Default.bakersdozen13ConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnPublicIndChanging(bool value);
    partial void OnPublicIndChanged();
    partial void OnActiveIndChanging(bool value);
    partial void OnActiveIndChanged();
    partial void OnDateTouchedChanging(System.DateTime value);
    partial void OnDateTouchedChanged();
    ...
    partial void OnCreateTimeStampChanged();
		...
		[Column(Storage="_ExpirationDate", DbType="SmallDateTime")]
		...
		[Column(Storage="_PublicInd", DbType="Bit NOT NULL")]
		public bool PublicInd
		{
			get
			{
				return this._PublicInd;
			}
			set
			{
				if ((this._PublicInd != value))
				{
					this.OnPublicIndChanging(value);
					this.SendPropertyChanging();
					this._PublicInd = value;
					this.SendPropertyChanged("PublicInd");
					this.OnPublicIndChanged();
				}
			}
		}
