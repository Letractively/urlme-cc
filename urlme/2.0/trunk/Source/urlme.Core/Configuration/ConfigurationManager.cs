...
namespace urlme.Core.Configuration
{
    ...
    public sealed class ConfigurationManager
    {
        ...
        /// </summary>
        private static string DefaultConfigurationFile = "urlme.Core.config";

        /// <summary>
        /// the cache key for the configuration key
        /// </summary>
        private static string ConfigurationManagerCacheKey = "urlme.Core.Configuration.ConfigurationManager.Instance";
